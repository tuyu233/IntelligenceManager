 ...
 * {@link #getResultItems()} get extract results to be used in {@link spider.pipeline.Pipeline}<br>
 * {@link #addTargetRequests(java.util.List)} {@link #addTargetRequest(String)} add urls to fetch                 <br>
 *
 * @author code4crafter@gmail.com <br>
 * @see spider.downloader.Downloader
 * @see spider.processor.PageProcessor
 * @since 0.1.0
 */
public class Page {
    ...
    public void setUrl(AbstractSelectable url) {
        this.url = url;
    }
