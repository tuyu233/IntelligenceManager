...
public class WordsReader {
   ...
   // public WordsReader(String file){
    ...
    String content=TagCloudHelper.getInstance().getInstanceContent();
    InputStream content_inputstream= new  ByteArrayInputStream(content.getBytes());
    /**
	...
	public Word[] getWords(){
        ...
        try {
            reader = new BufferedReader(new InputStreamReader(/*new FileInputStream(file)*/content_inputstream, UTF8));
