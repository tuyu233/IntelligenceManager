...
public class Information {
	private int numOfWebsites; // 网站数量

	private int numOfArticles;// 文章
	private int comments;// 评论
	private List<List<String>> hot_theme = null; // 主题：五组词，全网、政府、媒体、公众、再加上一组峰值年度的
	...
	public void setNumOfWebsites(int numOfWebsites) {
	...
	public void setHot_theme(List<List<String>> hot_theme) {
	...
	public List<List<String>> getHot_theme() {
		return hot_theme;
	}
